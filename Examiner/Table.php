...
class Table {
	...
	/**
	 * @param \Utils\DatabaseConnection $database Database connection
	 * @param string $table Table name
	 */
	public function __construct(\Bruha\Utils\DatabaseConnection $database, $table) {
	 ...
	 * @return \Utils\Object\Key\PrimaryKey|\Utils\Object\Key\UniqueKey|\Utils\Object\Key\IndexKey|\Utils\Object\Key\ForeignKey|boolean Column key
	 */
	private function getColumnKey(\stdClass $column) {
		if ($foreign = $this->getForeign($column->Field)) return $foreign;
		switch ($column->Key) {
			case 'PRI': return new \Bruha\Utils\Object\Key\PrimaryKey;
			case 'UNI': return new \Bruha\Utils\Object\Key\UniqueKey;
			case 'MUL': return new \Bruha\Utils\Object\Key\IndexKey;
			default: FALSE;
		}
	}
	 ...
	 * @return \Utils\Object\Key\ForeignKey|boolean Foreign key
	 */
